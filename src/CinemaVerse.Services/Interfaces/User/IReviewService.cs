...
namespace CinemaVerse.Services.Interfaces.User
{
    public interface IReviewService
    {
        ...
        Task<PagedResultDto<ReviewDto>> GetReviewsByMovieIdAsync(int movieId, int page, int pageSize);
        Task<PagedResultDto<ReviewDto>> GetUserReviewsAsync(int userId, int page, int pageSize);
